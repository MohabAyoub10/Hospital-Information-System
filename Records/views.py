...
class EmergencyContactViewSet(ModelViewSet):
    ...
    search_fields = ['first_name', 'last_name', 'national_id',
                     'patient__user__first_name', 'patient__user__national_id']
...
class SurgeryViewSet(ModelViewSet):
    ...
    search_fields = ['doctor__user__first_name', 'doctor__user__last_name',
                     'patient__user__first_name', 'patient__user__last_name', 'surgery_type']
    permission_classes = [IsMedicalSecretaryOrPatientDoctorReadOnly]
...
class PatientRecordsViewSet(ReadOnlyModelViewSet):
    queryset = Patient.objects.select_related('patient_record').prefetch_related('patient_vital').prefetch_related(
        'patient_surgery').prefetch_related('patient_surgery').prefetch_related('inpatient').all()
