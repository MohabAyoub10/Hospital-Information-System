...
class Bill(models.Model):
    ...
    radiology_request = models.ForeignKey(ExamRequest, on_delete=models.CASCADE,related_name='Bill_radiolgy', null=True,blank=True,)
    lab_request = models.ForeignKey(ExamRequest, on_delete=models.CASCADE,related_name='Bill_lab', null=True,blank=True)
