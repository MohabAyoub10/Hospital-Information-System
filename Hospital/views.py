...
class DoctorViewSet(CustomModelViewSet):
    ...
    queryset = Doctor.objects.select_related('user').select_related(
        'department').select_related('specialty').all()
